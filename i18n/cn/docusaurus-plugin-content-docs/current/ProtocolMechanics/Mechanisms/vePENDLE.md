...
:::warning[**vePENDLE 将被 sPENDLE 完全取代。** 最后一次 vePENDLE 投票将于 1 月 21 日 23:59（UTC）进行。]

自 **1 月 29 日 00:00（UTC）** 起，**vePENDLE 将停止续期**，并将进行一次快照，用于计算此次过渡期的 **vePENDLE 专属忠诚度奖励**。更多细节请参考文档中的 [sPENDLE 章节](./sPENDLE.md)。

:::

# vePENDLE (将被sPENDLE取代)

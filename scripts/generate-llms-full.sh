...
V2_FILES=(
  ...
  "$PENDLE_DOCS_DIR/ProtocolMechanics/DiscreteYield.md"
  # API integration
...
BOROS_USER_FILES=(
  ...
  "$BOROS_DOCS_DIR/arbitrage-with-crossex/overview.md"
  "$BOROS_DOCS_DIR/arbitrage-with-crossex/installation.md"
  "$BOROS_DOCS_DIR/arbitrage-with-crossex/setup-api-key.md"
  "$BOROS_DOCS_DIR/arbitrage-with-crossex/connecting-terminal.md"
  "$BOROS_DOCS_DIR/arbitrage-with-crossex/opening-a-position.md"
  "$BOROS_DOCS_DIR/arbitrage-with-crossex/monitoring-and-closing.md"
  "$BOROS_DOCS_DIR/arbitrage-with-crossex/risks-and-security.md"

...
1. [**Hold PT (short yield)**](chapter-6-shorting-yield.md)
2. [**Hold YT (long yield)**](chapter-8-long-yield-obtain-leveraged-yield-exposure.md)
...
{% hint style="info" %}
💡 See also [#how-can-i-predict-the-average-future-apy](chapter-8-long-yield-obtain-leveraged-yield-exposure.md#how-can-i-predict-the-average-future-apy "mention")
{% endhint %}

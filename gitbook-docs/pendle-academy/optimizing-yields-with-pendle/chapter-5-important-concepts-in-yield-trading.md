...
We have introduced the various terms and jargon in [Chapter 4 - Yield Trading Basics](chapter-4-yield-trading-basics-with-yt.md). Let’s explore these important yield trading concepts in more depth.

### PT + YT = Underlying asset

As a reminder, the core of Pendle’s [yield tokenization](../pendle-101/chapter-2-yield-tokenization-basics.md) is to split a yield-bearing token into PT and YT. The price of the two tokens adds up to the price of the underlying asset. Therefore, the price of PT and YT must be **inversely correlated** — the higher the YT price, the lower the PT price, and vice versa.

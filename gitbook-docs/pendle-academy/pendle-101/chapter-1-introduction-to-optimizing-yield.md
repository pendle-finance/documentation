...
<figure><img src="../.gitbook/assets/image (45).png" alt=""><figcaption><p>Yield fluctuates</p></figcaption></figure>
...
We will go through how to [earn passive earning](../optimizing-yields-with-pendle/chapter-3.1-fixed-yield-on-pendle.md) as well as [active trading strategies](../optimizing-yields-with-pendle/chapter-4-yield-trading-basics-with-yt.md) with Pendle in the next chapters.

***

### What can you do to earn better yields with Pendle

* [Passive earning](../optimizing-yields-with-pendle/chapter-3.1-fixed-yield-on-pendle.md)
...
* [Yield trading](../optimizing-yields-with-pendle/chapter-4-yield-trading-basics-with-yt.md)

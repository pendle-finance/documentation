...
<table data-view="cards"><thead><tr><th></th><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td></td><td><strong>YT / PT / LP</strong></td><td></td><td><a href="points-support-page.md#yt-pt-lp">#yt-pt-lp</a></td></tr><tr><td></td><td><strong>Risks</strong></td><td></td><td><a href="points-support-page.md#risks">#risks</a></td></tr><tr><td></td><td><strong>Balance is Down</strong></td><td></td><td><a href="points-support-page.md#balance-is-down">#balance-is-down</a></td></tr><tr><td></td><td><strong>Points Related</strong></td><td></td><td><a href="points-support-page.md#points-related">#points-related</a></td></tr><tr><td></td><td><strong>Keep YT Mode LP</strong></td><td></td><td><a href="points-support-page.md#zero-price-impact-lp">#zero-price-impact-lp</a></td></tr><tr><td></td><td><strong>LRT on Arbitrum</strong></td><td></td><td><a href="points-support-page.md#lrt-on-arbitrum">#lrt-on-arbitrum</a></td></tr><tr><td></td><td><strong>Capped Assets</strong></td><td></td><td><a href="points-support-page.md#usde-cap">#usde-cap</a></td></tr><tr><td></td><td><strong>Others</strong></td><td></td><td><a href="points-support-page.md#others">#others</a></td></tr></tbody></table>
...
Check out [#long-yield-apy](../../optimizing-yields-with-pendle/chapter-5-important-concepts-in-yield-trading.md#long-yield-apy "mention") to learn more about long-yield APY.

#### 4. Do I have to hold until maturity?

No. But see [#risks](points-support-page.md#risks "mention"), might be relevant for you.
...
That means YT's price is down. See [#id-1.-what-are-the-risks](points-support-page.md#id-1.-what-are-the-risks "mention") for a list of risks.
...
If PT's value declines, LP's balance declines alongside it as well as it comprises of partly PT. But note that PT's final value is known as it is a fixed yield position (See [here](points-support-page.md#yt-pt-lp) and [here](../../cheatsheet-for-the-impatient/pt-yt-lp-cheatsheet.md) to learn what PT is). This means **at maturity, there will be NO IL for LPs on Pendle**. There will be short-term fluctuations, but a long enough timeframe should result in a net-positive position.
...
Note that Pendle does NOT give nor generate additional points to enable YT's leverage. Pendle simply streams points from the underlying to YT holders. To learn more, see [here](./) and [here](../../yield-trading-deep-dives/chapter-8-long-yield-obtain-leveraged-yield-exposure.md).
...
&#xNAN;_&#x4F;NLY BRIDGE weETH, NOT eETH. Wrap your eETH to weETH at_ [_https://app.ether.fi/eeth/wrap_](https://app.ether.fi/eeth/wrap)
...
&#xNAN;_&#x49;f you used the native Arbitrum bridge, you have to bridge it back to Ethereum, which takes 7 days._

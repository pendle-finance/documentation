...
* You [earn a fixed yield by buying and holding PT](../optimizing-yields-with-pendle/chapter-3.1-fixed-yield-on-pendle.md). The difference between the entry cost and the redemption value is your fixed yield.
...
* You get [leveraged yield exposure](../yield-trading-deep-dives/chapter-8-long-yield-obtain-leveraged-yield-exposure.md) by buying YT, without liquidation or oracle risk.

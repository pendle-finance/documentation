...
[Holding PT](chapter-7-providing-liquidity-while-trading-yield.md#2.-how-to-be-yield-neutral-with-zero-price-impact-mode) gives you fixed yield that does not change with market conditions, and is a safe strategy that can still offer high returns.
...
This option is for intermediate or advanced users, because you will need to know how to [manage your YT position](../optimizing-yields-with-pendle/chapter-4-yield-trading-basics-with-yt.md).

...
<figure><img src="../.gitbook/assets/image (71).png" alt="" width="375"><figcaption><p>With the cost of 1 stETH, you are buying yield exposure of 11.9 ETH worth of stETH. An 11.9x leverage in notional value in this case.</p></figcaption></figure>

### When should I long yield and buy YT?

The last statement in the TLDR section can be condensed into a formula:

<figure><img src="../.gitbook/assets/image (72).png" alt=""><figcaption><p><em>The best way to frame yield trading is to think in APY terms, instead of dollar values.</em></p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (73).png" alt="" width="563"><figcaption><p>Implied APY Charts in the Pendle App</p></figcaption></figure>

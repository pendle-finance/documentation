...
![Click to expand rates](/boros-docs/imgs/arbitrage-with-crossex/click-to-expand-rates.png "Click to expand rates")
...
![Expanding arb details](/boros-docs/imgs/arbitrage-with-crossex/expanding-arb-details.png "Expanding arb details")
...
![Order ticket - Execute it](/boros-docs/imgs/arbitrage-with-crossex/order-ticket-execute-it.png "Order ticket - Execute it")
...
Once done, return to the app — you're now receiving fixed yield until maturity, and the **Positions** tab shows your estimated returns on capital.

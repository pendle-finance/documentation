...
![Close both perp legs](/boros-docs/imgs/crossex-terminal/close-both-perp-legs.png "Close both perp legs")
...
Your spread trade is now live. This is intended for traders who want to set up a perp spread before locking in fixed rates with Boros YUs, or who want specific limit orders for more advanced strategies. If you're new to funding rate arbitrage, use the guided terminal flow instead.

...
**API Documentation**: [https://api-v2.pendle.finance/core/docs](https://api-v2.pendle.finance/core/docs)
...
- **Pendle RESTful API**: Provides developers with accurate and up-to-date data, empowering them to build and innovate with the latest protocol information.
  - Documentation: [RESTful API](https://api-v2.pendle.finance/core/docs)

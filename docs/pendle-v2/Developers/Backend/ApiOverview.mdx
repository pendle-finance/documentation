...
Go to our [API dashboard](http://api-v2.pendle.finance/dashboard)
- Login with your wallet, you will be asked to sign a message to verify your identity
- Top-up the account with USDC/USDT/DAI in arbitrum
- Choose your plan & create a new API key

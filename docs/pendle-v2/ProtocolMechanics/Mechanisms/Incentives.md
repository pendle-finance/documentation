...
*Assume the USDe pool is maturing soon, with the renewal pool (next closest maturity) having $10M TVL. Under ordinary circumstances, it would receive 2.0% emission share under the default TVL Curve (Bootstrapping)*.

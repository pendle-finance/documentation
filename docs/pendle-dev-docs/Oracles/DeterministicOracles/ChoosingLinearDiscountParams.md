...
|----------------------|----------------------------------|
| ![Params notebook](/pendle-dev-docs/imgs/Oracles/ChoosingLinearDiscountParams/params-notebook.png) | ![Params Desmos](/pendle-dev-docs/imgs/Oracles/ChoosingLinearDiscountParams/params-desmos.png) |
...
|------------------------|----------------------------------|
| ![image.png](/pendle-dev-docs/imgs/Oracles/ChoosingLinearDiscountParams/ui-market-specs.png) | ![image.png](/pendle-dev-docs/imgs/Oracles/ChoosingLinearDiscountParams/ui-market-yield-range.png) |

And filled it as the following:

![image.png](/pendle-dev-docs/imgs/Oracles/ChoosingLinearDiscountParams/yield-range-desmos.png)
...
<video src="/pendle-dev-docs/imgs/Oracles/ChoosingLinearDiscountParams/desmos-toggle.webm" controls autoplay loop width="100%" />
...
![image.png](/pendle-dev-docs/imgs/Oracles/ChoosingLinearDiscountParams/lp-base-price-desmos.png)

...
The implied APY can be calculated using the `ptExchangeRate`. For a detailed explanation, refer to the [APY Calculation documentation](/pendle-v2/ProtocolMechanics/PendleMarketAPYCalculation).

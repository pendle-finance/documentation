...
[Holding PT](chapter-7-providing-liquidity-while-trading-yield#2-how-to-be-yield-neutral-with-keep-yt-mode) gives you fixed yield that does not change with market conditions, and is a safe strategy that can still offer high returns.

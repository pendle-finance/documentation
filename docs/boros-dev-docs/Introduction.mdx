...
| Section | Contents |
|---|---|
| **Backend Integration** | REST API, WebSocket, agent wallet setup, transaction submission via Send Txs Bot, best practices |
| **Historical Data** | Monthly NDJSON exports of trades, OHLCV candles, order book snapshots, settlement rates and market data |
| **Mechanics** | Order book matching, AMM pricing, margin system (cross vs isolated), settlement, fees, incentives |

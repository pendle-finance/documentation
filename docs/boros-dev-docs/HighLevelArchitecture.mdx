...
See [AMM Mechanics](./Mechanics/AMM.mdx) for pricing, the two AMM variants (Positive / Negative), liquidity provision, and how the AMM composes with the order book. The full mathematical specification is in the [AMM whitepaper](https://github.com/pendle-finance/boros-core-public/blob/main/whitepapers/AMM.pdf).

  ...
  borosSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        { type: "doc", id: "Backend/authentication", label: "Authentication", customProps: { icon: "key" } },
        { type: "doc", id: "Backend/sdk", label: "SDK (TypeScript)", customProps: { icon: "code" } },
        { type: "doc", id: "Backend/api", label: "API", customProps: { icon: "api" } },
        { type: "doc", id: "Backend/stop-orders", label: "Stop Orders", customProps: { icon: "trending_down" } },

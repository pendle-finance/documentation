...
Prefer `account-updates` for all new integrations. See [WebSocket — Account Update Events](./Backend/4.%20websocket.mdx#account-update-events) for the full payload schemas.

...
:::note Disclaimer
This data is carefully monitored to match the funding rates reported by each exchange. However, as we consume data from multiple exchanges and exchange APIs can occasionally be unstable, this data should be used as a reference only.
:::

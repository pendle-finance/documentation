...
- **Open API Docs:** [https://api.boros.finance/open-api/docs](https://api.boros.finance/open-api/docs)
- **Transaction Submission API Docs:** [https://api.boros.finance/send-txs-bot/docs](https://api.boros.finance/send-txs-bot/docs)
...
3. Submit signed transactions to `/send-txs-bot/v3/agent/bulk-direct-call`

...
- `orderbook:MARKET_ID:TICK_SIZE` – Orderbook updates for the given market, where TICK_SIZE refers to the price granularity. Accepted TICK_SIZE values are: 0.1, 0.01, 0.001, 0.0001, and 0.00001.

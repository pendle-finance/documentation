...
| [Historical Data](./7.%20historical-data.mdx) | Monthly NDJSON exports — trades, OHLCV, settlements, order book snapshots |
| [Indicators](./8.%20indicators.mdx) | Indicator letter codes (`u`, `fp`, `fgi`, `ap`, `udma`) and CSV export |
| [Computing Units](./9.%20computing-units.mdx) | How endpoint cost is reported and the static / dynamic CU model |
| [Bot Quickstart](./10.%20bot-quickstart.mdx) | End-to-end zero-to-functional grid bot — capstone that stitches the pages above into one runnable journey |
